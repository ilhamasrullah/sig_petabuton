...
CREATE TABLE `tb_tempat` (
  ...
  `tabel_presentasi` varchar(255) NOT NULL,
...
INSERT INTO `tb_tempat` (`id_tempat`, `nama_jalan`, `lat`, `lng`, `status_jalan`, `kecamatan`, `kerusakan`, `tabel_presentasi`, `penyebab`, `kelurahan`, `gambar`) VALUES
(1, 'Jln Poros Ereke - Buranga\r\n', 123.178787, -4.751542, 'Jalan Provinsi\r\n', 'Kulisusu\r\n', 'Pelapukan Permukaan\r\n', '4%', 'Jeleknya campuran lapis permukaan dan tidak tersedianya Drainase\r\n', 'Langke\r\n', '1.jpg'),
...
--
ALTER TABLE `tb_tempat`
  MODIFY `id_tempat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
COMMIT;
